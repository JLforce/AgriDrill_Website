        ...
        <section id="developers" className="mx-auto w-full max-w-7xl scroll-mt-24 px-4 py-20 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              { name: "Ybañez, Jafit Love R.", role: "Software Engineer", photo: "/ybanez-software.jpg", desc: "Develops the Mission Suite dashboard web application using TypeScript and integrates middleware to establish real-time system telemetry and live video stream monitoring." },
            ].map((member, idx) => (
              <article
                key={idx}
